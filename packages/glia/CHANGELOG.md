...
- Prebuilt stylesheet export (`@backbay/glia/styles.css`) for UI + theme defaults
- Lightweight entrypoint (`@backbay/glia/core`) for protocol/hooks/components without optional-heavy modules
