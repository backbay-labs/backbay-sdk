...
const darkWrapperStyle: React.CSSProperties = {
  ...
  '--glia-color-bg-elevated': 'rgba(17, 17, 17, 0.95)',
  ...
  '--glia-color-accent-positive': '#44c444',
  '--glia-color-accent-warning': '#e6a817',
  '--glia-glass-panel-bg': 'rgba(17, 17, 17, 0.8)',
  '--glia-glass-hover-bg': 'rgba(212, 168, 75, 0.10)',
  '--glia-blur-backdrop': 'blur(12px)',
  '--glia-radius-md': '3px',
  '--glia-radius-sm': '2px',
  '--glia-font-mono': "'IBM Plex Mono', 'SF Mono', monospace",
  '--glia-font-body': "'Inter', sans-serif",
  '--glia-font-display': "'Inter', sans-serif",
