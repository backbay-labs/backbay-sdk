...
const darkWrapper = (Story: React.ComponentType) => (
  <div
    style={{
      '--bb-color-window-bg': '#0a0a0a',
      '--bb-color-window-border': '#333333',
      '--bb-color-titlebar-bg': '#111111',
      '--bb-color-titlebar-text': '#cccccc',
      ...
      '--bb-color-icon-text': '#cccccc',
      '--bb-color-icon-selected': 'rgba(212, 168, 75, 0.08)',
      '--bb-color-desktop-bg': '#010100',
      '--bb-color-context-menu-bg': '#111111',
      ...
      '--bb-radius-button': '3px',
      '--bb-radius-menu': '3px',
      '--bb-radius-input': '3px',
      '--bb-radius-window': '4px',
      background: '#010100',
      width: '100%',
      height: '500px',
      padding: '0',
...
export const InWindow: Story = {
  render: () => (
    <div style={{
      ...
      height: '420px',
      margin: '20px auto',
      border: '1px solid var(--bb-color-window-border, #333)',
      borderRadius: 'var(--bb-radius-window, 4px)',
      overflow: 'hidden',
      display: 'flex',
      ...
      <div style={{
        ...
        alignItems: 'center',
        padding: '0 12px',
        background: 'var(--bb-color-titlebar-bg, #111)',
        borderBottom: '1px solid var(--bb-color-window-border, #333)',
        fontFamily: 'var(--bb-font-display, serif)',
        fontSize: '11px',
        fontWeight: 600,
        letterSpacing: '0.1em',
