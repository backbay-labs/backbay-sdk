/**
 * @cyntra/verify - Browser-side verification of Cyntra attestations
 *
 * This package provides cryptographic verification of Cyntra RunReceipts
 * directly in the browser using WebAssembly, enabling trustless verification.
 *
 * @example
 * ```ts
 * import { initWasm, verifyReceipt, fetchAndVerifyChain } from '@cyntra/verify';
 *
