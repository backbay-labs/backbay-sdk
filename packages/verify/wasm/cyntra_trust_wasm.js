 ...
 * ```
 * @param {string} receipt_json
 * @param {string} kernel_pubkey_hex
 * @param {string | null} [verifier_pubkey_hex]
 * @param {string | null} [provider_pubkey_hex]
 * @returns {any}
 */
export function verify_receipt(receipt_json, kernel_pubkey_hex, verifier_pubkey_hex, provider_pubkey_hex) {
    const ptr0 = passStringToWasm0(receipt_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(kernel_pubkey_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    var ptr2 = isLikeNone(verifier_pubkey_hex) ? 0 : passStringToWasm0(verifier_pubkey_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len2 = WASM_VECTOR_LEN;
    var ptr3 = isLikeNone(provider_pubkey_hex) ? 0 : passStringToWasm0(provider_pubkey_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('cyntra_trust_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
